...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if (in_array($action, ['verify_article', 'unverify_article'], true) && $articleId > 0) {
        ...
        if (isset($result['ok'])) {
            ...
            redirect('/pages/unverified-articles.php', null, $message);
        }

        redirect('/pages/unverified-articles.php', $result['error'] ?? 'Unable to review article.');
    }
}
    ...
    <div class="page-content">
        ...
        <div class="card mb-6" style="padding:20px 24px">
            ...
            <div class="flex items-center gap-3 mt-6" style="flex-wrap:wrap">
                <form method="POST" style="margin:0" onsubmit="return confirm('Verify this article? It will publish once every assigned expert verifies it.')">
                ...
                <form method="POST" style="margin:0" onsubmit="return confirm('Reject this article? It will be moved back to draft for the author.')">
