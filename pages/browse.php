...
//variables used for filtering, sorting, and pagination
//initialize variables here for use in the page
...
?> <!-- use system admin shell(light mode) if user is system admin -->
